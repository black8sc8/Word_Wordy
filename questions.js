...
const allQuestions = [
    ...
    { kor: "강이 길어 🌊", eng: "The river is long" },
    ...
    { kor: "할머니 안녕하세요 👵", eng: "Hello, Grandma." },
    ...
    { kor: "오렌지 주스 주세요 🍊", eng: "I'd like orange juice, please" },
    ...
    { kor: "양은 털이 많아 🐑", eng: "A sheep has a lot of wool" },
    ...
    { kor: "웃어봐 치즈 😁", eng: "Smile and say cheese." },
    ...
    { kor: "손이 더러워 🖐️", eng: "The hands are dirty" },
    ...
    { kor: "아기는 어려 👶", eng: "The baby is young" },
    ...
    { kor: "월요일이 시작이야 📅", eng: "Monday is the start of the week" },
    ...
    { kor: "십이월은 크리스마스야 🎄", eng: "Christmas is in December" },
    ...
    { kor: "시간이 빨라 ⏳", eng: "Time goes by quickly" },
